...
Use /sources to toggle sources""",
        ...
        'pause_success': "⏸️ *Daily digests paused.*\n\nYou won't receive scheduled news until you type /resume.",
        'pause_already': "⏸️ Your digests are already paused. Type /resume to restart them.",
        'resume_success': "▶️ *Daily digests resumed!*\n\nYou will receive your news at {time}.",
        'resume_already': "▶️ Your digests are already active at {time}.",
        'resume_no_time': "❌ You haven't set a schedule time yet. Use /schedule to set one.",
...
Используйте /sources чтобы настроить источники""",
        ...
        'pause_success': "⏸️ *Ежедневные дайджесты приостановлены.*\n\nВы не будете получать новости по расписанию, пока не введете /resume.",
        'pause_already': "⏸️ Ваши дайджесты уже приостановлены. Введите /resume для возобновления.",
        'resume_success': "▶️ *Ежедневные дайджесты возобновлены!*\n\nВы будете получать новости в {time}.",
        'resume_already': "▶️ Ваши дайджесты уже активны на {time}.",
        'resume_no_time': "❌ Вы еще не установили время расписания. Используйте /schedule для настройки.",
