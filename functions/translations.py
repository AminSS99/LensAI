...
• /export - Export saved articles to markdown file
...
Use /sources to toggle sources""",
        ...
        'export_title': "LensAI Saved Articles",
        'export_empty': "📂 **Export Empty**\n\nYou haven't saved any articles yet! Use `/save` to start saving.",
...
• /export - Экспорт сохраненных статей в markdown файл
...
Используйте /sources чтобы настроить источники""",
        ...
        'export_title': "Сохраненные статьи LensAI",
        'export_empty': "📂 **Экспорт пуст**\n\nУ вас еще нет сохраненных статей! Используйте `/save`, чтобы начать сохранять.",
        'export_success': "✅ **Экспорт завершен**\n\nВот ваши {count} сохраненных статей в формате markdown.",
