...
MESSAGES = {
    'en': {
        ...
        'search_suggested_header': "💡 *Suggested topics:*",
...
Use /sources to toggle sources""",
        ...
        'btn_summarize_week': "🧠 Summarize My Week",
        'summarizing_week': "🔄 Generating your weekly AI summary...",
        ...
        'reading_link': "🔄 Extracting article text...",
        ...
        'clear_read_btn': "🗑️ Clear Read",
        'mark_all_read_btn': "✅ Mark All Read",
        'mark_all_read_prompt': "⚠️ **Are you sure you want to mark all saved articles as read?**",
        'mark_all_read_confirm_btn': "✅ Yes, mark all read",
        'mark_all_read_cancel_btn': "❌ Cancel",
        'marked_all_read': "✅ All articles marked as read!",

        'clear_read_prompt': "⚠️ **Are you sure you want to delete all READ articles?**",
        ...
        # Breaking news
        'breaking_on': "✅ Breaking news alerts enabled!\n\nI'll notify you immediately when a major news spike is detected.",
        'breaking_off': "🚫 Breaking news alerts disabled.",
        'breaking_status_on': "🚨 Breaking news alerts: *ON*\n\nYou'll receive instant alerts for major news spikes.\n\nUse `/breaking off` to disable.",
        'breaking_status_off': "🚨 Breaking news alerts: *OFF*\n\nUse `/breaking on` to enable instant alerts for major news spikes.",

        # Stalker
        'stalk_list_header': "📡 *Your Stalk List*\n\nCompanies and repos you're tracking:",
        'stalk_empty': "📡 *Stalk List*\n\nYou're not tracking anything yet.\n\nUse `/stalk <company>` to track a company\nUse `/stalk repo:<owner/repo>` to track a GitHub repo",
        'stalk_added_company': "✅ Now stalking *{name}*!\n\nYou'll get alerts when {name} publishes directly.",
        'stalk_added_repo': "✅ Now stalking repo *{name}*!\n\nYou'll get alerts for new releases.",
        'stalk_removed': "🗑️ Removed *{name}* from your stalk list.",
        'stalk_not_found': "❌ *{name}* not found in your stalk list.",
        'stalk_invalid_repo': "❌ Invalid repo format. Use `owner/repo` (e.g., `python/cpython`)",
        'stalk_duplicate': "ℹ️ You're already stalking *{name}*.",

        # Predictive bookmarking
        'predict_save_btn': "🔮 Save Predicted",
        'predict_saved': "✅ Saved predicted article!",

        # Deep dive
        'deep_dive_queued': "🔍 Deep dive queued! I'll send you additional context in a few minutes.",
    ...
    'ru': {
        ...
        'search_suggested_header': "💡 *Предложенные темы:*",
        'searching': "🔍 Ищу **{query}**...",
...
Используйте /sources чтобы настроить источники""",
        ...
        'btn_summarize_week': "🧠 Итоги моей недели (ИИ)",
        'summarizing_week': "🔄 Генерирую ИИ-сводку за неделю...",
        ...
        'clear_read_btn': "🗑️ Очистить прочитанные",
        'mark_all_read_btn': "✅ Отметить все как прочитанные",
        'mark_all_read_prompt': "⚠️ **Вы уверены, что хотите отметить все сохраненные статьи как прочитанные?**",
        'mark_all_read_confirm_btn': "✅ Да, отметить все",
        'mark_all_read_cancel_btn': "❌ Отмена",
        'marked_all_read': "✅ Все статьи отмечены как прочитанные!",

        'clear_read_prompt': "⚠️ **Вы уверены, что хотите удалить ПРОЧИТАННЫЕ статьи?**",
        ...
        # Breaking news
        'breaking_on': "✅ Экстренные уведомления включены!\n\nЯ сразу сообщу о резком всплеске новостей.",
        'breaking_off': "🚫 Экстренные уведомления отключены.",
        'breaking_status_on': "🚨 Экстренные уведомления: *ВКЛ*\n\nВы будете получать мгновенные алерты о всплесках новостей.\n\nИспользуйте `/breaking off` чтобы отключить.",
        'breaking_status_off': "🚨 Экстренные уведомления: *ВЫКЛ*\n\nИспользуйте `/breaking on` чтобы включить мгновенные алерты.",

        # Stalker
        'stalk_list_header': "📡 *Ваш список отслеживания*\n\nКомпании и репозитории, за которыми вы следите:",
        'stalk_empty': "📡 *Список отслеживания*\n\nВы пока ничего не отслеживаете.\n\nИспользуйте `/stalk <компания>` для компании\nИспользуйте `/stalk repo:<владелец/репо>` для GitHub-репозитория",
        'stalk_added_company': "✅ Теперь отслеживаю *{name}*!\n\nВы будете получать новости прямо от {name}.",
        'stalk_added_repo': "✅ Теперь отслеживаю репозиторий *{name}*!\n\nВы будете получать уведомления о новых релизах.",
        'stalk_removed': "🗑️ Удалил *{name}* из списка отслеживания.",
        'stalk_not_found': "❌ *{name}* не найден в вашем списке.",
        'stalk_invalid_repo': "❌ Неверный формат репозитория. Используйте `владелец/репо` (например, `python/cpython`)",
        'stalk_duplicate': "ℹ️ Вы уже отслеживаете *{name}*.",

        # Predictive bookmarking
        'predict_save_btn': "🔮 Сохранить рекомендацию",
        'predict_saved': "✅ Рекомендованная статья сохранена!",

        # Deep dive
        'deep_dive_queued': "🔍 Глубокий анализ поставлен в очередь! Я пришлю дополнительный контекст через несколько минут.",
