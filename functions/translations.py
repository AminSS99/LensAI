...
Use /sources to toggle sources""",
        ...
        'stats_empty': "📊 **No reading stats available!**\n\nStart saving articles to see your statistics.",
        'stats_message': "📊 **Your Reading Stats**\n\n📚 **Total saved:** {total}\n📈 **Saved this week:** {weekly}\n🏆 **Top category:** {top_category}\n📰 **Top source:** {top_source}",
...
Используйте /sources чтобы настроить источники""",
        ...
        'stats_empty': "📊 **Нет данных для статистики!**\n\nНачните сохранять статьи, чтобы увидеть вашу статистику.",
        'stats_message': "📊 **Ваша статистика чтения**\n\n📚 **Всего сохранено:** {total}\n📈 **За эту неделю:** {weekly}\n🏆 **Любимая категория:** {top_category}\n📰 **Главный источник:** {top_source}",
